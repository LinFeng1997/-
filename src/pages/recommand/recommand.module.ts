...
import { RecommandCourse } from './recommand-course';
...
@NgModule({
  ...
  imports: [
    ...
    IonicPageModule.forChild(RecommandCourse),
...
export function provideStorage() {
  ...
  return new Storage({driverOrder:['sqlite', 'websql', 'indexeddb','localstorage']})
}