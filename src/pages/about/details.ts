...
import { Events,ModalController, LoadingController, ToastController } from 'ionic-angular';
...
export class DetailsPage extends AbstractComponent implements OnInit {
	...
	constructor(public navCtrl: NavController,
		...
		super(cfg, navCtrl, toastCtrl, loadingCtrl,null,null,null,null,null,null,null,eventCtrl);
	}
	ngOnInit() {
	...
	loadTeacherDetails() {
		...
		this.teacherDetails.forEach((e) => {
			...
			// console.log(arr);
			let teacherModel = new TeacherDetailsModel(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7],arr[8],arr[9],arr[10]);
